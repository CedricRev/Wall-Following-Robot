...
OBJECTS    = waller.o ultrasonic.o motors.o timer0.o
TEST_OBJECTS = ultrasonic.o motors.o waller.o timer0.o
...
test_readings.elf: test_readings.o uart.o ultrasonic.o servo.o motor.o
	$(COMPILE) -o test_readings.elf test_readings.o uart.o ultrasonic.o servo.o motor.o